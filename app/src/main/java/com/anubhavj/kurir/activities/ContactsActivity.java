...
import com.anubhavj.kurir.fragments.ContactsFragment;
import com.anubhavj.kurir.fragments.PendingContactRequestsFragment;
...
public class ContactsActivity extends BaseAuthenticatedActivity implements AdapterView.OnItemSelectedListener {
    ...
    public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
        ...
        currentAnimation = ObjectAnimator.ofObject(toolbar, " backgroundColor", new ArgbEvaluator(), currentColor, item.getColor()).setDuration(250);
        ...
        try{
            ...
            Log.e("ContactsActivitAy","Could not instantiate fragment "+item.getFragment().getName(), e);
            return;
